...
function plain(message: string): string {
  // Strip ANSI colors for file logs.
...
export const log = {
  ...
  banner(): void {
    ...
    console.log(paint('cyan', '║') + bold + paint('white', '   Azure → MongoDB ETL Pipeline          ') + reset + paint('cyan', '║'));
    console.log(paint('cyan', '╚══════════════════════════════════════════╝'));
    console.log('');
    writeToFile(`[${nowStamp()}] Azure → MongoDB ETL Pipeline`);
  },
